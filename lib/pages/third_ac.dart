...
class ThirdACPage extends StatefulWidget {
  const ThirdACPage({super.key});

  @override
  _ThirdACPageState createState() => _ThirdACPageState();
}

class _ThirdACPageState extends State<ThirdACPage> {
  ...
  Widget buildSeatContainer(String seatNumber, int columnIndex, int rowIndex) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isSearchedSeat ? Colors.pink : Colors.teal,
